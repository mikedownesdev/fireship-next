...
/**
 * A special way to update a firestore document that allows
 * you to update an existing count on a document.
 * 
 * In our case, that means we can update the heart count without
 * needing to actually know the heart count on the server
 */
